...
Export all apps created by the user. Optionally, provide a list of app IDs to export.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **export_apps_operation_input** | [**ExportAppsOperationInput**](ExportAppsOperationInput.md)|  | [optional] 
