...
[**delete_broker**](BrokersApi.md#delete_broker) | **DELETE** /api/v2/brokers/{brokerId} | 
[**get_broker_by_id**](BrokersApi.md#get_broker_by_id) | **GET** /api/v2/brokers/{brokerId} | 
[**get_brokers**](BrokersApi.md#get_brokers) | **GET** /api/v2/brokers | 
[**patch_broker**](BrokersApi.md#patch_broker) | **PATCH** /api/v2/brokers/{brokerId} | 
...
with cyperf.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.delete_broker(broker_id)
    except Exception as e:
        print("Exception when calling BrokersApi->delete_broker: %s\n" % e)
```
...
with cyperf.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_broker_by_id(broker_id)
        print("The response of BrokersApi->get_broker_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BrokersApi->get_broker_by_id: %s\n" % e)
```
...
# **patch_broker**
> patch_broker(broker_id, broker=broker)
...
with cyperf.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.patch_broker(broker_id, broker=broker)
    except Exception as e:
        print("Exception when calling BrokersApi->patch_broker: %s\n" % e)
```
