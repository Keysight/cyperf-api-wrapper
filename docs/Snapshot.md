...
**values** | **List[List[AppsecAppMetadataKeywordsInner]]** | The values of the snapshot. The order of the values corresponds to the order of columns in result. | [optional] 
