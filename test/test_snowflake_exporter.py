...
class TestSnowflakeExporter(unittest.TestCase):
    """SnowflakeExporter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SnowflakeExporter:
        """Test SnowflakeExporter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnowflakeExporter`
        """
        model = SnowflakeExporter()
        if include_optional:
            return SnowflakeExporter(
                active = True,
                polling_interval = 56,
                profile = cyperf.models.params.Params(
                    array_element_type = '', 
                    array_elements = [
                        {
                            'key' : ''
    ...
    def testSnowflakeExporter(self):
        """Test SnowflakeExporter"""
