...
class Snapshot(BaseModel):
    ...
    values: Optional[List[List[AppsecAppMetadataKeywordsInner]]] = Field(default=None, description="The values of the snapshot. The order of the values corresponds to the order of columns in result.")
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "timestamp": obj.get("timestamp"),
                        "values": (
                [
                    [AppsecAppMetadataKeywordsInner.from_dict(_inner_item) for _inner_item in _item]
