...
class Attack(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ActionTimeout", "Active", "ClientHTTPProfile", "Connections", "ConnectionsMaxTransactions", "Description", "DestinationHostname", "DnnId", "EndPointID", "Endpoints", "ExternalResourceURL", "id", "Index", "InheritHTTPProfile", "IpPreference", "IsDeprecated", "IterationCount", "links", "MaxActiveLimit", "Name", "NetworkMapping", "Params", "ProtocolID", "QosFlowId", "ReadonlyMaxTrans", "ServerHTTPProfile", "SupportsClientHTTPProfile", "SupportsHTTPProfiles", "SupportsServerHTTPProfile", "ClientTLSProfile", "create", "InheritTLS", "modify-excluded-dut-recursively", "modify-tags-recursively", "ServerTLSProfile", "SupportsTLS", "Tracks"]
