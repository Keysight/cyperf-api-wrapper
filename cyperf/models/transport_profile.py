...
class TransportProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ClientHTTPProfile", "ClientQUICProfile", "ClientTLSProfile", "ClientTcpProfile", "IpTos", "LLMAPIProfiles", "RTPProfile", "ServerHTTPProfile", "ServerQUICProfile", "ServerTLSProfile", "ServerTcpProfile", "UdpProfile", "VlanPrio", "links", "L4ProfileName"]
