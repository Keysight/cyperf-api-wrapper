...
class TransportProfileBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ClientHTTPProfile", "ClientTcpProfile", "ClientTLSProfile", "IpTos", "links", "RTPProfile", "ServerHTTPProfile", "ServerTcpProfile", "ServerTLSProfile", "UdpProfile", "VlanPrio"]
