...
class AgentsApi:
    ...
    @validate_call
    def get_compute_node_port_by_id(
        self,
        ...
        _param = self._get_compute_node_port_by_id_serialize(
    ...
    def get_compute_node_ports(
        ...
        _param = self._get_compute_node_ports_serialize(
            controller_id=controller_id,
            compute_node_id=compute_node_id,
            take=take,
            skip=skip,
    ...
    def get_controller_by_id(
        ...
        _param = self._get_controller_by_id_serialize(
            controller_id=controller_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_controller_compute_node_by_id(
        self,
        controller_id: Annotated[StrictStr, Field(description="The ID of the controller.")],
        compute_node_id: Annotated[StrictStr, Field(description="The ID of the compute node.")],
        _request_timeout: Union[
        ...
        _param = self._get_controller_compute_node_by_id_serialize(
            controller_id=controller_id,
            compute_node_id=compute_node_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_controller_compute_nodes(
        self,
        controller_id: Annotated[StrictStr, Field(description="The ID of the controller.")],
        take: Annotated[Optional[StrictInt], Field(description="The number of search results to return")] = None,
        skip: Annotated[Optional[StrictInt], Field(description="The number of search results to skip")] = None,
        ...
        _param = self._get_controller_compute_nodes_serialize(
            controller_id=controller_id,
            take=take,
            skip=skip,
            _request_auth=_request_auth,
    ...
    def start_agents_batch_delete(
        ...
        _param = self._start_agents_batch_delete_serialize(
    ...
    def start_agents_export_files(
        ...
        _param = self._start_agents_export_files_serialize(
    ...
    def start_agents_reboot(
        ...
        _param = self._start_agents_reboot_serialize(
    ...
    def start_agents_release(
        ...
        _param = self._start_agents_release_serialize(
    ...
    def start_agents_reserve(
        ...
        _param = self._start_agents_reserve_serialize(
    ...
    @validate_call
    def start_agents_set_dpdk_mode(
        self,
        ...
        _param = self._start_agents_set_dpdk_mode_serialize(
    ...
    def start_agents_set_ntp(
        ...
        _param = self._start_agents_set_ntp_serialize(
    ...
    def start_agents_update(
        ...
        _param = self._start_agents_update_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def start_controllers_set_app(
        self,
        set_controller_app_operation: Optional[SetControllerAppOperation] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param set_controller_app_operation:
        :type set_controller_app_operation: SetControllerAppOperation
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._start_controllers_set_app_serialize(
            set_controller_app_operation=set_controller_app_operation,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _start_controllers_set_app_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if set_controller_app_operation is not None:
            _body_params = set_controller_app_operation
    ...
    @validate_call
    def start_controllers_set_node_app(
        self,
        set_nodes_app_operation: Optional[SetNodesAppOperation] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param set_nodes_app_operation:
        :type set_nodes_app_operation: SetNodesAppOperation
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._start_controllers_set_node_app_serialize(
            set_nodes_app_operation=set_nodes_app_operation,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def start_controllers_set_node_app_with_http_info(
        self,
        set_nodes_app_operation: Optional[SetNodesAppOperation] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def start_controllers_set_node_app_without_preload_content(
        self,
        set_nodes_app_operation: Optional[SetNodesAppOperation] = None,
        _request_timeout: Union[
            None,
    ...
    def _start_controllers_set_node_app_serialize(
        self,
        set_nodes_app_operation,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if set_nodes_app_operation is not None:
            _body_params = set_nodes_app_operation
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/controllers/operations/set-node-app',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def start_controllers_update_port_tags(
        self,
        update_port_tags_operation: Optional[UpdatePortTagsOperation] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param update_port_tags_operation:
        :type update_port_tags_operation: UpdatePortTagsOperation
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._start_controllers_update_port_tags_serialize(
            update_port_tags_operation=update_port_tags_operation,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def start_controllers_update_port_tags_with_http_info(
        self,
        update_port_tags_operation: Optional[UpdatePortTagsOperation] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def start_controllers_update_port_tags_without_preload_content(
        self,
        update_port_tags_operation: Optional[UpdatePortTagsOperation] = None,
        _request_timeout: Union[
            None,
    ...
    def _start_controllers_update_port_tags_serialize(
        self,
        update_port_tags_operation,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_port_tags_operation is not None:
            _body_params = update_port_tags_operation
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/controllers/operations/update-port-tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
